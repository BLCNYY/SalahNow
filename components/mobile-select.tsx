            ...
            <div className="px-4 py-3 border-b border-border">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-11 pr-4 bg-muted/50 rounded-xl text-base placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
            </div>
                ...
                <div className="py-2">
                  {filteredOptions.map((option) => (
                    <button
                      ...
                      className={cn(
                        "w-full flex items-center justify-between px-6 py-4 text-left text-lg touch-manipulation active:bg-muted/50 transition-colors",
