...
- Should see `NEXT_PUBLIC_APP_URL` = `https://waqt.blcnyy.dev` (from `netlify.toml`)
- If you want to override it, add it manually here

## Verify Deployment

- ✅ Visit `https://waqt.blcnyy.dev`
...
3. Add env var: `NEXT_PUBLIC_APP_URL=https://waqt.blcnyy.dev`
4. Deploy
...
- Check status: `dig waqt.blcnyy.dev`
